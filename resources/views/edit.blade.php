            ...
            <div class="card-body px-5 py-5">
              ...
              <form action="{{ route('profile.update',['id'=>profile->id]) }}" method="post">
                 ...
                 <div class="form-group">
                  <label>Name:</label>
                  <input type="text" class="form-control p_input" name="name" placeholder="name" value="{{$profile->name}}">
                </div>
				
                <div class="form-group">
                  <label> Email: </label>
                  <input type="email" class="form-control p_input" name="email" placeholder="email" value="{{$profile->eamil}}">
                </div>
                <div class="form-group">
                  <label>Password:</label>
                  <input type="password" class="form-control p_input" name="password" placeholder="password" value="{{$profile->password}}">
                </div>
				 <div class="form-group">
                  <label>Phone:</label>
                  <input type="text" class="form-control p_input" name="phone" placeholder="phone" value="{{$profile->phone}}">
                </div>
