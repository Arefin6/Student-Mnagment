                ...
                <div class="col-12">
                  <table id="order-listing" class="table table-striped" style="width:100%;">
                    ...
                    @foreach($teachers as $teacher)
                        <tr>
                            <td>
                               <img src="{{$teacher->img}}" alt="" width="90px">
                            </td>
                            <td>
                             {{$teacher->name}}
                            </td>
                            ...
                            <td>
                               ...
                               <a href="{{route('teacher.edit',['id' => $teacher->id])}}" class="btn btn-lg btn-info">Edit</a>     
                    ...
                    @else
                    	<tr>
                    		<th colspan="5" class="text-center">No Teacher Yet</th>
                    	</tr>
